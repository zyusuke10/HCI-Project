  ...
  return (
    <div className="specificEventPage-container">
      ...
      <div className="speicifcEventPage-container-main">
        ...
        <div className={darkMode ? "specificEvent-details-container-dark" : "specificEvent-details-container"}>
          <div className="specificEvent-title">
            <h4 className={darkMode ? "dark-mode-text" : "light-mode-text2"}>{name}</h4>
          </div>
          <div className="specificEvent-desc">
            <h5 className={darkMode ? "dark-mode-text" : "light-mode-text2"}>Description</h5>
            <p className={darkMode ? "dark-mode-text" : "light-mode-text2"}>{desc}</p>
          </div>
          <div className="specificEvent-details">
            <div className="specificEvent-location">
              <img src={pin} alt="pin" />
              <p className={darkMode ? "dark-mode-text" : "light-mode-text2"}>{location}</p>
            </div>
            <div className="specificEvent-phone">
              <img src={phone1} alt="phone" />
              <p className={darkMode ? "dark-mode-text" : "light-mode-text2"}>{phone}</p>
            </div>
            <div className="specificEvent-time">
              <img src={clock} alt="clock" />
              <p className={darkMode ? "dark-mode-text" : "light-mode-text2"}>{time}</p>
            </div>
            <div className="specificEvent-price">
              <img src={priceTag} alt="price tag" />
              <p className={darkMode ? "dark-mode-text" : "light-mode-text2"}>{price}</p>
            </div>

            <Link to="/profile">
              <div
                className={darkMode ? "addTicket-container-dark" : "addTicket-container"}
